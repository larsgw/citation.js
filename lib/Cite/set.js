...
var _chain = _interopRequireDefault(require("../parse/input/chain"));

var _chain2 = _interopRequireDefault(require("../parse/input/async/chain"));
...
var add = function add(data) {
  ...
  (_data = this.data).push.apply(_data, _toConsumableArray((0, _chain.default)(data, options)));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return (0, _chain2.default)(data, options);
