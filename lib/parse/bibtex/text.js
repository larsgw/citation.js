...
var parseBibTeX = function parseBibTeX(str) {
  ...
  try {
    ...
    while (stack.tokensLeft()) {
      ...
      console.log(3, stack.stack.slice(stack.index, stack.index + 20).join(''));
      stack.consumeToken(',');
      console.log(3, stack.stack.slice(stack.index, stack.index + 20).join(''));
      ...
      var _loop = function _loop() {
        console.log(0, stack.stack.slice(stack.index, stack.index + 20).join(''));
        ...
        stack.consumeToken(',', { spaced: false });
        console.log(1, stack.stack.slice(stack.index, stack.index + 20).join(''));
        stack.consumeWhitespace();
        console.log(2, stack.stack.slice(stack.index, stack.index + 20).join(''));
