...
var validate = function validate(format, parsers) {
  ...
  if (dataType && typeof dataType !== 'string') {
    ...
    throw new TypeError('Invalid type parser, expected object, got ' + (0, _dataType.typeOf)(propertyConstraint));
  } else if (elementConstraint && typeof elementConstraint !== 'string') {
    throw new TypeError('Invalid type parser, expected string, got ' + (0, _dataType.typeOf)(elementConstraint));
