        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt('return', Promise.all(Object.keys(data.entities).map(function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(entityKey) {
                var _this = this;
                    ...
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        return Promise.all(Object.keys(entity).map(function () {
                          var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(prop) {
