require = function e(t, n, r) {
    ...
    1: [ function(require, module, exports) {
        ...
        exports.byteLength = function(b64) {
            ...
            2 === placeHolders ? (tmp = revLookup[b64.charCodeAt(i)] << 2 | revLookup[b64.charCodeAt(i + 1)] >> 4, 
            ...
            1 === extraBytes ? (tmp = uint8[len - 1], output += lookup[tmp >> 2], output += lookup[tmp << 4 & 63], 
    ...
    2: [ function(require, module, exports) {
        ...
        function from(value, encodingOrOffset, length) {
            ...
            return isArrayBuffer(value) ? function(array, byteOffset, length) {
                ...
                var buf;
                buf = byteOffset === undefined && length === undefined ? new Uint8Array(array) : length === undefined ? new Uint8Array(array, byteOffset) : new Uint8Array(array, byteOffset, length);
                return buf.__proto__ = Buffer.prototype, buf;
        ...
        Buffer.alloc = function(size, fill, encoding) {
            return function(size, fill, encoding) {
                return assertSize(size), size <= 0 ? createBuffer(size) : fill !== undefined ? "string" == typeof encoding ? createBuffer(size).fill(fill, encoding) : createBuffer(size).fill(fill) : createBuffer(size);
            }(size, fill, encoding);
            ...
            var i;
            if (length === undefined) for (length = 0, i = 0; i < list.length; ++i) length += list[i].length;
            ...
            if ((length === undefined || length > remaining) && (length = remaining), string.length > 0 && (length < 0 || offset < 0) || offset > this.length) throw new RangeError("Attempt to write outside buffer bounds");
        ...
        Buffer.prototype.slice = function(start, end) {
            var len = this.length;
            start = ~~start, end = end === undefined ? len : ~~end, start < 0 ? (start += len) < 0 && (start = 0) : start > len && (start = len), 
    ...
    3: [ function(require, module, exports) {
        ...
        var Response = function() {
            function Response(statusCode, headers, body, url) {
                if ("number" != typeof statusCode) throw new TypeError("statusCode must be a number but was " + _typeof(statusCode));
                if (null === headers) throw new TypeError("headers cannot be null");
                if ("object" !== _typeof(headers)) throw new TypeError("headers must be an object but was " + _typeof(headers));
                this.statusCode = statusCode;
                var headersToLowerCase = {};
                for (var key in headers) headersToLowerCase[key.toLowerCase()] = headers[key];
                this.headers = headersToLowerCase, this.body = body, this.url = url;
            }
            return Response.prototype.isError = function() {
                return 0 === this.statusCode || this.statusCode >= 400;
            }, Response.prototype.getBody = function(encoding) {
                var err;
                if (0 === this.statusCode) throw (err = new Error("This request to " + this.url + " resulted in a status code of 0. This usually indicates some kind of network error in a browser (e.g. CORS not being set up or the DNS failing to resolve):\n" + this.body.toString())).statusCode = this.statusCode, 
                err.headers = this.headers, err.body = this.body, err.url = this.url, err;
                if (this.statusCode >= 300) throw (err = new Error("Server responded to " + this.url + " with status code " + this.statusCode + ":\n" + this.body.toString())).statusCode = this.statusCode, 
                err.headers = this.headers, err.body = this.body, err.url = this.url, err;
                return encoding && "string" != typeof this.body ? this.body.toString(encoding) : this.body;
            }, Response;
        }();
    ...
    5: [ function(require, module, exports) {
        ...
        var handle_qs_js_1 = require("then-request/lib/handle-qs.js"), GenericResponse = require("http-response-object"), fd = FormData;
        function doRequest(method, url, options) {
            var match, xhr = new XMLHttpRequest();
            if ("string" != typeof method) throw new TypeError("The method must be a string.");
            if (url && "object" === _typeof(url) && (url = url.href), "string" != typeof url) throw new TypeError("The URL/path must be a string.");
            if (null !== options && options !== undefined || (options = {}), "object" !== _typeof(options)) throw new TypeError("Options must be an object (or null).");
            method = method.toUpperCase(), options.headers = options.headers || {};
            var crossDomain = !(!(match = /^([\w-]+:)?\/\/([^\/]+)/.exec(url)) || match[2] == location.host);
            for (var name in crossDomain || (options.headers["X-Requested-With"] = "XMLHttpRequest"), 
            options.qs && (url = handle_qs_js_1["default"](url, options.qs)), options.json && (options.body = JSON.stringify(options.json), 
            options.headers["content-type"] = "application/json"), options.form && (options.body = options.form), 
            xhr.open(method, url, !1), options.headers) xhr.setRequestHeader(name.toLowerCase(), "" + options.headers[name]);
            xhr.send(options.body ? options.body : null);
            var headers = {};
            return xhr.getAllResponseHeaders().split("\r\n").forEach(function(header) {
                var h = header.split(":");
                h.length > 1 && (headers[h[0].toLowerCase()] = h.slice(1).join(":").trim());
            }), new GenericResponse(xhr.status, headers, xhr.responseText, url);
        }
        exports.FormData = fd, exports["default"] = doRequest, module.exports = doRequest, 
        module.exports["default"] = doRequest, module.exports.FormData = fd;
    }, {
        "http-response-object": 3,
        "then-request/lib/handle-qs.js": 6
    } ],
    6: [ function(require, module, exports) {
        ...
        exports["default"] = function(url, query) {
            var _a = url.split("?"), start = _a[0], part2 = _a[1], qs = (part2 || "").split("#")[0], end = part2 && part2.split("#").length > 1 ? "#" + part2.split("#")[1] : "", baseQs = qs_1.parse(qs);
            for (var i in query) baseQs[i] = query[i];
            return "" !== (qs = qs_1.stringify(baseQs)) && (qs = "?" + qs), start + qs + end;
        };
    }, {
        qs: 8
    } ],
    ...
    9: [ function(require, module, exports) {
        ...
        module.exports = function(str, opts) {
            ...
            if (null !== options.decoder && options.decoder !== undefined && "function" != typeof options.decoder) throw new TypeError("Decoder has to be a function.");
            ...
            "" === str || null === str || void 0 === str) return options.plainObjects ? Object.create(null) : {};
            for (var tempObj = "string" == typeof str ? function(str, options) {
                for (var obj = {}, cleanStr = options.ignoreQueryPrefix ? str.replace(/^\?/, "") : str, limit = options.parameterLimit === Infinity ? undefined : options.parameterLimit, parts = cleanStr.split(options.delimiter, limit), i = 0; i < parts.length; ++i) {
    ...
    10: [ function(require, module, exports) {
        ...
        var utils = require("./utils"), formats = require("./formats"), arrayPrefixGenerators = {
        ...
        module.exports = function(object, opts) {
            ...
            if (null !== options.encoder && options.encoder !== undefined && "function" != typeof options.encoder) throw new TypeError("Encoder has to be a function.");
            ...
            if ("object" !== _typeof(obj) || null === obj) return "";
        ...
        exports.arrayToObject = function(source, options) {
            ...
            if ("object" !== _typeof(source)) {
                if (Array.isArray(target)) target.push(source); else {
                    if ("object" !== _typeof(target)) return [ target, source ];
                    (options.plainObjects || options.allowPrototypes || !has.call(Object.prototype, source)) && (target[source] = !0);
                }
                return target;
            }
            if ("object" !== _typeof(target)) return [ target ].concat(source);
            ...
            Array.isArray(target) && Array.isArray(source) ? (source.forEach(function(item, i) {
                has.call(target, i) ? target[i] && "object" === _typeof(target[i]) ? target[i] = exports.merge(target[i], item, options) : target.push(item) : target[i] = item;
            ...
            for (var queue = [ {
                ...
                "object" === _typeof(val) && null !== val && -1 === refs.indexOf(val) && (queue.push({
                    obj: obj,
                    prop: key
                }), refs.push(val));
            }
        ...
        module.exports = {
            entities: {
                Q21972834: {
                    ...
                    title: "Q21972834",
                    lastrevid: 594203123,
                    modified: "2017-11-14T19:42:25Z",
                    type: "item",
                    id: "Q21972834",
                    labels: {
                        en: {
                            language: "en",
                            value: "Assembling the 20 Gb white spruce (Picea glauca) genome from whole-genome shotgun sequencing data"
                        },
                        nl: {
                            language: "nl",
                            value: "Assembling the 20 Gb white spruce (Picea glauca) genome from whole-genome shotgun sequencing data"
                    ...
                    descriptions: {
                        ...
                        nl: {
                            language: "nl",
                            value: "wetenschappelijk artikel (gepubliceerd op 2013/06/15)"
                        },
                        cs: {
                            language: "cs",
                            value: "v\u011bdeck\xfd \u010dl\xe1nek publikovan\xfd v roce 2013"
                        },
                        fr: {
                            language: "fr",
                            value: "article scientifique (publi\xe9 2013/06/15)"
                        },
                        it: {
                            language: "it",
                            value: "articolo scientifico (pubblicato il 2013/06/15)"
                        },
                        da: {
                            language: "da",
                            value: "videnskabelig artikel (udgivet  2013/06/15)"
                        },
                        sk: {
                            language: "sk",
                            value: "vedeck\xfd \u010dl\xe1nok (publikovan\xfd 2013/06/15)"
                        },
                        pt: {
                            language: "pt",
                            value: "artigo cient\xedfico (publicado na 2013/06/15)"
                        },
                        hy: {
                            language: "hy",
                            value: "\u0563\u056b\u057f\u0561\u056f\u0561\u0576 \u0570\u0578\u0564\u057e\u0561\u056e"
                        },
                        ar: {
                            language: "ar",
                            value: "\u0645\u0642\u0627\u0644\u0629 \u0639\u0644\u0645\u064a\u0629 (\u0646\u0634\u0631\u062a \u0641\u064a 15-6-2013)"
                        },
                        de: {
                            language: "de",
                            value: "wissenschaftlicher Artikel (ver\xf6ffentlicht am 15 Juni 2013)"
                        },
                        sq: {
                            language: "sq",
                        ...
                        es: {
                            language: "es",
                            value: "art\xedculo cient\xedfico publicado en 2013"
                        },
                        lt: {
                            language: "lt",
                            value: "mokslinis straipsnis"
                        },
                        vi: {
                            language: "vi",
                            value: "b\xe0i b\xe1o khoa h\u1ecdc"
                        },
                        ru: {
                            language: "ru",
                        ...
                        ast: {
                            language: "ast",
                            value: "art\xedculu cient\xedficu"
                        },
                        ka: {
                            language: "ka",
                        ...
                        "pt-br": {
                            language: "pt-br",
                            value: "artigo cient\xedfico"
                        },
                        hu: {
                            language: "hu",
                            value: "tudom\xe1nyos cikk"
                        },
                        et: {
                            language: "et",
                    ...
                    claims: {
                        P698: [ {
                            ...
                            type: "statement",
                            id: "Q21972834$D435A2F3-E2A8-45A7-922A-A6BB72F9A79C",
                            rank: "normal",
                            references: [ {
                                hash: "9581e8725c1608f503d588ed3a6e01d95b185b23",
                                snaks: {
                                    P248: [ {
                                        snaktype: "value",
                                        property: "P248",
                        ...
                        P932: [ {
                            ...
                            type: "statement",
                            id: "Q21972834$F4959183-FB89-410E-BF33-DF9B1AF81ECE",
                            rank: "normal",
                            references: [ {
                                hash: "9581e8725c1608f503d588ed3a6e01d95b185b23",
                                snaks: {
                        ...
                        P31: [ {
                            ...
                            type: "statement",
                            id: "Q21972834$E4DCC072-BD1A-4FDF-BFED-E1D981E5E81F",
                            rank: "normal"
                        } ],
                        P1476: [ {
                            mainsnak: {
                                ...
                                datavalue: {
                                    value: {
                                        text: "Assembling the 20 Gb white spruce (Picea glauca) genome from whole-genome shotgun sequencing data",
                                        language: "en"
                                    },
                            ...
                            type: "statement",
                            id: "Q21972834$D8C2FFB6-2710-4AFA-92A3-A859ABAA1FED",
                            rank: "normal"
                        } ],
                        P478: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q21972834$963935D7-041A-4E92-9D9B-F254A5426BAD",
                            rank: "normal"
                        } ],
                        P433: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q21972834$47B925A9-A53F-43A3-888D-BEA79E399D4D",
                            rank: "normal"
                        } ],
                        P577: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q21972834$9EDE475C-7403-4A66-A6A5-0458E7782689",
                            rank: "normal"
                        } ],
                        P304: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q21972834$92D5DD57-B5F0-42B6-9508-6D5CEB82FF3C",
                            rank: "normal"
                        } ],
                        P2093: [ {
                            mainsnak: {
                            ...
                            id: "Q21972834$BC54A9F8-68FF-4F6E-8111-A449A15BDB57",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$CB76DCFD-DA2A-4673-ACDB-B8CA71D1069C",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$CC360BCE-0D0D-4E92-8F68-1780D1106620",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$EC1B7589-BE7F-450C-B4AE-978EF4440682",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$AA1A005B-0985-4CCB-AB13-782A3385EB54",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$A0812623-AA81-48CB-AA51-1E04CCC21FE9",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$6A62350D-4505-43DF-A8D4-719B8282ED8E",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$B78884CC-1F88-45B1-B1B3-DD9DDF2B2FBE",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$C9117C71-EAEB-4DC0-909B-9876C53A3802",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$22C57E2F-6C2C-46DC-B184-0CA7F529B6C3",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$C86DCED7-41A0-4653-9E9F-AEDD1BB5392C",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$507B8D2B-1EA4-492D-93E8-3D9236BDECB7",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$99499BC4-F219-4E8E-B79C-0FFC4AF1919F",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$2A452CB5-1392-48A3-8BDF-C3859ECD2CD7",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$ED126A91-2089-4B3C-8BB6-D7FE81E05C63",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$9D020847-DAD2-4573-8896-C6826BEBB4DD",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "56e77a2eea22fa436528789b1e88f73ebce53a92",
                                    datavalue: {
                                        value: "20",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$76CDF015-D56A-4539-9A29-ED6328566BA9",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "f5a226ebb11ff3cb8c41370357acdc8ede4a3224",
                                    datavalue: {
                                        value: "22",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$382410E5-912A-4D08-BEA6-238379D5BA61",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "0f81c461e0edbb9c5613e6b49511d44fefcaeec1",
                                    datavalue: {
                                        value: "24",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$E584D000-D3FA-48EB-B0B6-18A64D489469",
                            rank: "normal"
                        } ],
                        P2860: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q21972834$067675E1-BE45-48EC-9927-9B505DCD2C38",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                                    P248: [ {
                                        snaktype: "value",
                                        property: "P248",
                                    ...
                                    P854: [ {
                                        ...
                                        property: "P854",
                                        datavalue: {
                                            value: "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/elink.fcgi?dbfrom=pmc&linkname=pmc_refs_pubmed&retmode=json&id=3673215",
                                            type: "string"
                                        },
                                        datatype: "url"
                                    } ],
                            ...
                            type: "statement",
                            id: "Q21972834$B272C2D7-F0C1-4B7E-B5F0-ADBD60D235EB",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$85D12800-291A-4885-8DDE-42657DE6E026",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$EA35C15C-3F08-41DE-A369-06B084B6BAA3",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$9F920256-4000-405C-AACB-E96C6D992603",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$8F12AA50-1D1B-42C6-B6AD-E9A9587F53EB",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$A4899485-8489-4D70-82E7-82C216106962",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$FD2F304E-61D2-41EE-8AB5-B5CA1267B7CB",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$113AD736-4A2B-479D-BA9D-0615FEA01A84",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$16FE34E1-5AAC-4D98-898A-7CC4699861F0",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$A0BF94ED-B679-4A17-B68A-2FE7AF6858AA",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$513BAA39-8D82-4485-A25D-DB222C90B284",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$DD899F96-5D71-4BBC-A87E-B710B870C6C3",
                            rank: "normal",
                            references: [ {
                                hash: "c3f3095725ed8dbca34582aaaebbf0ff4e5473bd",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$6841DAE3-4A88-426D-878D-A8320B56F389",
                            rank: "normal",
                            references: [ {
                                hash: "027d43a2f0e454d327c064532b8169344ca9c479",
                                snaks: {
                                    P248: [ {
                                        snaktype: "value",
                                        property: "P248",
                            ...
                            type: "statement",
                            id: "Q21972834$8DB197DA-99D5-436F-AA57-3553E59F0575",
                            rank: "normal",
                            references: [ {
                                hash: "027d43a2f0e454d327c064532b8169344ca9c479",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$483D0AAB-8A16-494B-96F5-A507460BD5D5",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                                    P248: [ {
                                        snaktype: "value",
                                        property: "P248",
                            ...
                            type: "statement",
                            id: "Q21972834$65364437-C75A-45F4-8907-482D125C66CA",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$BC4B4E8C-F714-45CF-8C05-7980AAECB044",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$DD7EB85B-9B3D-4BF7-B704-64759D231C5F",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$76315A27-AE66-4137-8B5F-183097F5425E",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$8F4EC1C1-A1EF-48C5-9367-BDB40377B74D",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$B56DF036-3F98-4EDE-AB53-E10D182E3006",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$66B679B2-45E4-41A3-B97A-D42C704DAD1F",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$0D0FA045-842B-4ADB-B6A7-AD2ABE53B112",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$E78669A8-D271-4542-8540-8BC00D59B227",
                            rank: "normal",
                            references: [ {
                                hash: "58fd59bd76c326e470647556ebc287113579967f",
                                snaks: {
                            ...
                            type: "statement",
                            id: "Q21972834$75EBD061-E902-4A52-B985-DF80811A7613",
                            rank: "normal",
                            references: [ {
                                hash: "573e725ddbb0ec0ba9390fd06f5ca02d8842d7fa",
                                snaks: {
                                    P248: [ {
                                        snaktype: "value",
                                        property: "P248",
                        ...
                        P1433: [ {
                            ...
                            type: "statement",
                            id: "Q21972834$72BB933D-4685-4F38-AE7C-1FBB71952A69",
                            rank: "normal",
                            references: [ {
                                hash: "0f777b69d8d3a65ccde0a935ad2e100b32e54ef9",
                                snaks: {
                                    P248: [ {
                                        snaktype: "value",
                                        property: "P248",
                        ...
                        P3181: [ {
                            ...
                            type: "statement",
                            id: "Q21972834$FDDF4A83-6970-4A50-8A59-26DFA5C2621C",
                            rank: "normal",
                            references: [ {
                                hash: "9581e8725c1608f503d588ed3a6e01d95b185b23",
                                snaks: {
                        ...
                        P921: [ {
                            ...
                            type: "statement",
                            id: "Q21972834$e8eae0f3-4581-47f5-9528-04c967854423",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q21972834$64a4a2b9-4d01-0532-bfd4-605bd9484f3c",
                            rank: "normal"
                        } ],
                        P356: [ {
                            mainsnak: {
                                ...
                                property: "P356",
                                datavalue: {
                                    value: "10.1093/BIOINFORMATICS/BTT178",
                                    type: "string"
                                },
                                datatype: "external-id"
                            },
                            type: "statement",
                            id: "Q21972834$2FB0F783-8FE0-4E40-9080-7CD9DBD6906B",
                            rank: "normal",
                            references: [ {
                                hash: "9581e8725c1608f503d588ed3a6e01d95b185b23",
                                snaks: {
                        ...
                        P50: [ {
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "a921621b61855fb454e1096de9b0fc91b21bfa9b",
                                    datavalue: {
                                        value: "23",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$F3B493D0-A576-4959-8950-6D43D7995CC4",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "9d22b928e2a536181e7576da40198990b72f9197",
                                    datavalue: {
                                        value: "21",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$27A38427-E938-4631-A0F4-7992D282E8F9",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$9283F501-FB54-42BB-A504-3F07A499867F",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q21972834$95E03FEE-E787-429D-A330-63D5AA1A4538",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                ...
                                P1932: [ {
                                    snaktype: "value",
                                    property: "P1932",
                                    hash: "6530fee4ffabeab260a77bf78146abde9523a870",
                                    datavalue: {
                                        value: "Christopher I Keeling",
                                        type: "string"
                                    },
                                    datatype: "string"
                                } ]
                            },
                            "qualifiers-order": [ "P1545", "P1932" ],
                            id: "Q21972834$1F045850-DBC8-46DE-B6FA-C0AA8BF25B3C",
                            rank: "normal"
                        } ],
                        P407: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q21972834$785E0AE5-4741-443B-B8F2-039E4F1935A4",
                            rank: "normal"
                        } ]
                    },
                    sitelinks: []
        ...
        module.exports = {
            entities: {
                Q27795847: {
                    ...
                    title: "Q27795847",
                    lastrevid: 453265099,
                    modified: "2017-02-20T20:13:32Z",
                    type: "item",
                    id: "Q27795847",
                    labels: {
                        en: {
                            language: "en",
                            value: "SPLASH, a hashed identifier for mass spectra"
                        },
                        nl: {
                            language: "nl",
                            value: "SPLASH, a hashed identifier for mass spectra"
                    ...
                    descriptions: {
                        fr: {
                            language: "fr",
                            value: "article scientifique (publi\xe9 2016/11/08)"
                        },
                        cs: {
                            language: "cs",
                            value: "v\u011bdeck\xfd \u010dl\xe1nek publikovan\xfd v roce 2016"
                        },
                        nl: {
                            language: "nl",
                            value: "wetenschappelijk artikel (gepubliceerd op 2016/11/08)"
                        },
                        it: {
                            language: "it",
                            value: "articolo scientifico (pubblicato il 2016/11/08)"
                        },
                        sk: {
                            language: "sk",
                            value: "vedeck\xfd \u010dl\xe1nok (publikovan\xfd 2016/11/08)"
                        },
                        da: {
                            language: "da",
                            value: "videnskabelig artikel (udgivet  2016/11/08)"
                        },
                        pt: {
                            language: "pt",
                            value: "artigo cient\xedfico (publicado na 2016/11/08)"
                        },
                        en: {
                            language: "en",
                            value: "scientific article"
                    ...
                    claims: {
                        P31: [ {
                            ...
                            type: "statement",
                            id: "Q27795847$FE0E533D-7E2D-4FC1-AB73-22196E9D9455",
                            rank: "normal"
                        } ],
                        P577: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q27795847$7695c7e8-4988-843f-d638-1a765f6bd0f1",
                            rank: "normal"
                        } ],
                        P1476: [ {
                            mainsnak: {
                                ...
                                datavalue: {
                                    value: {
                                        text: "SPLASH, a hashed identifier for mass spectra",
                                        language: "en"
                                    },
                                    type: "monolingualtext"
                                },
                            ...
                            type: "statement",
                            id: "Q27795847$c12e8199-4e9b-8d86-1f89-c53255e1b89f",
                            rank: "normal"
                        } ],
                        P2093: [ {
                            mainsnak: {
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "862c83ca2949d7eb8f41b4bf1a4521ed18cdebb8",
                                    datavalue: {
                                        value: "1",
                                        type: "string"
                                    },
                                ...
                                P1416: [ {
                                    snaktype: "value",
                                    property: "P1416",
                                    hash: "17f7c88944bcd21a5b1de89be8babd7895377505",
                                    datavalue: {
                                        value: {
                                            "entity-type": "item",
                                            "numeric-id": 129421,
                            ...
                            "qualifiers-order": [ "P1545", "P1416" ],
                            id: "Q27795847$5a37a217-4790-7488-341c-3f40aac679d5",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "af1310a34ec80620d4fdd7bb8ca76e492fe6630e",
                                    datavalue: {
                                        value: "2",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$e029413e-465a-6e7f-bbc4-7bf7d095bdf5",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "3c1e388cba3487113121af5bfa59a2f657bf21bd",
                                    datavalue: {
                                        value: "3",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$459a6034-4de2-d02c-71b3-de0d009d3ca0",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "c8e1b85012703eb0f44ff876ec773596f3794872",
                                    datavalue: {
                                        value: "5",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$27938ccf-4c1f-0fdc-5250-8c9b7ab1ab0c",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "5d30572c5a5693878a66231c29c9bb3e4a870527",
                                    datavalue: {
                                        value: "6",
                                        type: "string"
                                    },
                                ...
                                P1416: [ {
                                    snaktype: "value",
                                    property: "P1416",
                                    hash: "a47de0d3aa3e3d2844ebf22e9624c4efb47ccbdd",
                                    datavalue: {
                                        value: {
                                            "entity-type": "item",
                                            "numeric-id": 825987,
                            ...
                            "qualifiers-order": [ "P1545", "P1416" ],
                            id: "Q27795847$4414bb01-4540-a5d2-bb41-78cee294f865",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "ebbb7b4bd5f12eaa0eb9415b51fd725fd993a644",
                                    datavalue: {
                                        value: "9",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$b76ba909-4412-7b4b-1b29-acc6b19a31c3",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "938c75f8b1bafb9e19a4c1a079b8b8e5d997c7fa",
                                    datavalue: {
                                        value: "11",
                                        type: "string"
                                    },
                                ...
                                P1416: [ {
                                    snaktype: "value",
                                    property: "P1416",
                                    hash: "6f8ef5a2bbb33916e6b5870a7274e8730efa1f21",
                                    datavalue: {
                                        value: {
                                            "entity-type": "item",
                                            "numeric-id": 1153275,
                            ...
                            "qualifiers-order": [ "P1545", "P1416" ],
                            id: "Q27795847$f55f9709-47c0-879a-80ee-468a59ee7993",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "472f0889b6914293dcbc4d0f62bb3e3ce6d37ce0",
                                    datavalue: {
                                        value: "12",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$8c511a6b-4213-8d9d-ed2c-61261d710ca9",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "a0d6d71b9401a527331dc2a8a59c54448b5ad98c",
                                    datavalue: {
                                        value: "13",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$84869301-4041-a4b4-3496-f0f724c03ac5",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "89d1857be00646d34838dc372e42882e3e20dca2",
                                    datavalue: {
                                        value: "14",
                                        type: "string"
                                    },
                                ...
                                P1416: [ {
                                    snaktype: "value",
                                    property: "P1416",
                                    hash: "777bee7b0612da6cfca8a663b6c60ffdbed72f98",
                                    datavalue: {
                                        value: {
                                            "entity-type": "item",
                                            "numeric-id": 622664,
                            ...
                            "qualifiers-order": [ "P1545", "P1416" ],
                            id: "Q27795847$d1287f99-4e2f-c26a-2257-1fa71a5f9b67",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "502af995394385a6c11fd2f00b65598853ceedc5",
                                    datavalue: {
                                        value: "15",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$05d35d06-4164-b410-d163-7228c8a6bacf",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$975616fd-41c1-5797-f792-16d317d4e17c",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                                property: "P2093",
                                datavalue: {
                                    value: "Venkata Chandrasekhar Nainala",
                                    type: "string"
                                },
                                datatype: "string"
                            },
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "c5201cb20b41dc2f0e2cf1361e16829d4cfbeac8",
                                    datavalue: {
                                        value: "18",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$68c00f70-40f7-52ac-6b51-27340aee5757",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "5ffccd25ee75ecddecb8ccbb1a59226cc3ba535a",
                                    datavalue: {
                                        value: "19",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$7e774c4a-41f4-c0c9-b0ee-391e74a772dd",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "481220fb9e6317d9e822186cb47365497d25e036",
                                    datavalue: {
                                        value: "20",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$8d8845f3-44c5-b259-8aea-b55827411fdc",
                            rank: "normal"
                        } ],
                        P478: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q27795847$a090a3aa-4a02-fbe5-9aca-df819f80e84c",
                            rank: "normal"
                        } ],
                        P304: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q27795847$9ec79308-4361-58b7-2219-df398124c52e",
                            rank: "normal"
                        } ],
                        P1433: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q27795847$b771b8e8-4ccd-82d8-02e0-df734ad9b35b",
                            rank: "normal"
                        } ],
                        P921: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q27795847$b4edba31-4e22-d1d0-60fd-8e7a4258a3a4",
                            rank: "normal"
                        } ],
                        P50: [ {
                            mainsnak: {
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "a89a718f20b227073f3b4f3aa4ad0e99ba77b542",
                                    datavalue: {
                                        value: "17",
                                        type: "string"
                                    },
                                ...
                                P1416: [ {
                                    snaktype: "value",
                                    property: "P1416",
                                    hash: "3c814103e8488af45c5f9ddb4f3a83548284f46a",
                                    datavalue: {
                                        value: {
                                            "entity-type": "item",
                                            "numeric-id": 1341845,
                            ...
                            "qualifiers-order": [ "P1545", "P1416" ],
                            id: "Q27795847$cfda0f9e-40ab-fe07-d2c1-a646a2588c34",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "c6a0d2bbafefdc6d21b25af4357c9887085c2f89",
                                    datavalue: {
                                        value: "8",
                                        type: "string"
                                    },
                                ...
                                P1416: [ {
                                    snaktype: "value",
                                    property: "P1416",
                                    hash: "f3f4b1106be9c9432af1675a98182889725faf11",
                                    datavalue: {
                                        value: {
                                            "entity-type": "item",
                                            "numeric-id": 19845644,
                                ...
                                P1932: [ {
                                    snaktype: "value",
                                    property: "P1932",
                                    hash: "f897727ae72d779987cc1cbb9f667d3e7c74a0c2",
                                    datavalue: {
                                        value: "Egon L Willighagen",
                                        type: "string"
                                    },
                                    datatype: "string"
                                } ]
                            },
                            "qualifiers-order": [ "P1545", "P1416", "P1932" ],
                            id: "Q27795847$4a94239d-4f1b-77a8-41b6-2c04e1f5a079",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "ecdcd65e6c9f103dedc06d856ce957af15050f7b",
                                    datavalue: {
                                        value: "7",
                                        type: "string"
                                    },
                                ...
                                P1416: [ {
                                    snaktype: "value",
                                    property: "P1416",
                                    hash: "2af45dffb1e796266913f5fecff0b01fb42a2142",
                                    datavalue: {
                                        value: {
                                            "entity-type": "item",
                                            "numeric-id": 678765,
                            ...
                            "qualifiers-order": [ "P1545", "P1416" ],
                            id: "Q27795847$85eb14b2-4d1e-fbaa-ce18-7b92398da5d5",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "6d824c4548dc9c84054b9e446b8ea72e50efebba",
                                    datavalue: {
                                        value: "10",
                                        type: "string"
                                    },
                                ...
                                P1416: [ {
                                    snaktype: "value",
                                    property: "P1416",
                                    hash: "072d0bc1ba7876a9edfe9766e4dd2c83d759f3e6",
                                    datavalue: {
                                        value: {
                                            "entity-type": "item",
                                            "numeric-id": 640694,
                            ...
                            "qualifiers-order": [ "P1545", "P1416" ],
                            id: "Q27795847$34c7ffad-48b7-582d-aee0-04e6694250fb",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "a39223fc722bb1c9ca54fe188d9596d0c68f055e",
                                    datavalue: {
                                        value: "21",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545", "P1416" ],
                            id: "Q27795847$990b9ecd-4746-5ebc-2209-510172d627f2",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            qualifiers: {
                                P1545: [ {
                                    snaktype: "value",
                                    property: "P1545",
                                    hash: "a82b0aa3ccf1a266e15473824b4391f6d9da4be0",
                                    datavalue: {
                                        value: "4",
                                        type: "string"
                                    },
                            ...
                            "qualifiers-order": [ "P1545" ],
                            id: "Q27795847$a9af48e3-4afb-4281-1b0b-7c8405afd325",
                            rank: "normal"
                        } ],
                        P2860: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q27795847$51189732-4cae-29ac-9c3d-5f52e4076684",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$b3a68adf-4629-432a-a2fe-c5afb5d478a0",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$25db773a-4265-1451-58ff-d9a8d0fc2c90",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$906aa8f9-4163-5c7c-c17e-7a83329babee",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$6a239bbf-4e74-5eb1-dd40-1bd734e00dad",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$a6aaa6b6-4fab-6667-4347-08af84b83958",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$6e77205b-4fea-719e-237e-323ffdc5de53",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$fd046765-4ec1-4773-dbc4-adb5a2d43490",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$13ecb48e-49bf-5c2c-81a7-dcbc953f46fc",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$9569723d-4d9b-05ad-dfaa-f0be798cc8e4",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$8a414bd4-4676-dfa6-70bf-2cc8ffdfdb9c",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$ef170bc8-4a44-e40b-209c-9fad35846433",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$e101201a-4092-253b-ea90-80b52d65e153",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$39288916-4bcc-bb5d-6165-a3e7d8557230",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$1e9ee22e-4181-0f42-3bac-8b6bf7325ddc",
                            rank: "normal"
                        }, {
                            mainsnak: {
                                snaktype: "value",
                            ...
                            type: "statement",
                            id: "Q27795847$15ec6ec7-4db2-3bbb-bfaf-a924b6482e51",
                            rank: "normal"
                        } ],
                        P1104: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q27795847$be33113d-4b0c-7756-ecf1-ec78c0605209",
                            rank: "normal"
                        } ],
                        P953: [ {
                            mainsnak: {
                                ...
                                property: "P953",
                                datavalue: {
                                    value: "http://rdcu.be/msZj",
                                    type: "string"
                                },
                                datatype: "url"
                            },
                            type: "statement",
                            id: "Q27795847$9ae54b43-42bd-2c08-9347-eecb6838ae00",
                            rank: "normal"
                        } ],
                        P698: [ {
                            mainsnak: {
                            ...
                            type: "statement",
                            id: "Q27795847$7CCFB068-30E5-4A85-A1AA-85981F7752E8",
                            rank: "normal"
                        } ],
                        P356: [ {
                            mainsnak: {
                                ...
                                property: "P356",
                                datavalue: {
                                    value: "10.1038/NBT.3689",
                                    type: "string"
                                },
                                datatype: "external-id"
                            },
                            type: "statement",
                            id: "Q27795847$BDC0D3CE-51FB-4058-B1AE-BD9CF1DCB5DE",
                            rank: "normal"
                        } ]
                    },
                    sitelinks: []
    ...
    15: [ function(require, module, exports) {
        "use strict";
        var _expect = _interopRequireDefault(require("expect.js")), _citation = _interopRequireDefault(require("./citation")), _api = require("./api"), _parse = _interopRequireDefault(require("./input/parse")), _parse2 = _interopRequireDefault(require("./output/parse"));
        ...
        (0, _api.setUp)("wikidata"), describe(".async()", function() {
            var noGraph = {
                generateGraph: !1
            };
                        ...
                        it("works", function() {
                            return new Promise(function(resolve) {
                                _citation["default"].async(_parse["default"].wd.id, noGraph, function(instance) {
                                    (0, _expect["default"])(instance).to.be.a(_citation["default"]), (0, _expect["default"])(instance.data).to.eql(_parse2["default"].wd.simple), 
                                    resolve();
                                });
                            });
                        });
                ...
                it("works", _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
                    ...
                    return regeneratorRuntime.wrap(function(_context2) {
                        for (;;) switch (_context2.prev = _context2.next) {
                          case 0:
                            return _context2.next = 2, _citation["default"].async(_parse["default"].wd.id, noGraph);

                          case 2:
                            instance = _context2.sent, (0, _expect["default"])(instance).to.be.a(_citation["default"]), 
    ...
    17: [ function(require, module, exports) {
        "use strict";
        var _expect = _interopRequireDefault(require("expect.js")), _citation = _interopRequireDefault(require("./citation")), _cite = _interopRequireDefault(require("./input/cite"));
        function _interopRequireDefault(obj) {
            return obj && obj.__esModule ? obj : {
                "default": obj
            };
        ...
        describe("Cite instance", function() {
            describe("initialisation", function() {
                ...
                return it("works", function() {
                    ...
                    (0, _expect["default"])(function(arr) {
                        if (Array.isArray(arr)) {
                            for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) arr2[i] = arr[i];
                            return arr2;
                        }
                        return Array.from(arr);
                    }(new _citation["default"](_cite["default"].ids, noGraph))).to.eql(_cite["default"].ids);
                });
                ...
                beforeEach(function() {
                    ...
                    it("works", function() {
                        test.add(_cite["default"].empty), (0, _expect["default"])(test.data).to.have.length(2), 
                        (0, _expect["default"])(test.log).to.have.length(1);
                    }), it("saves", function() {
                        test.add(_cite["default"].empty, !0), (0, _expect["default"])(test.data).to.have.length(2), 
                        (0, _expect["default"])(test.log).to.have.length(2);
                    });
                }), describe("set()", function() {
                    it("works", function() {
                        test.set(_cite["default"].ids, noGraph), (0, _expect["default"])(test.data).to.have.length(2), 
                        (0, _expect["default"])(test.data).to.eql(_cite["default"].ids), (0, _expect["default"])(test.log).to.have.length(1);
                    }), it("saves", function() {
                        test.set(_cite["default"].empty, !0), (0, _expect["default"])(test.data).to.have.length(1), 
                        (0, _expect["default"])(test.log).to.have.length(2);
                    });
                    ...
                    it("works", _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
                        return regeneratorRuntime.wrap(function(_context) {
                            for (;;) switch (_context.prev = _context.next) {
                              case 0:
                                return _context.next = 2, test.addAsync(_cite["default"].empty);

                              case 2:
                                (0, _expect["default"])(test.data).to.have.length(2), (0, _expect["default"])(test.log).to.have.length(1);
                        ...
                        return regeneratorRuntime.wrap(function(_context2) {
                            for (;;) switch (_context2.prev = _context2.next) {
                              case 0:
                                return _context2.next = 2, test.addAsync(_cite["default"].empty, !0);

                              case 2:
                                (0, _expect["default"])(test.data).to.have.length(2), (0, _expect["default"])(test.log).to.have.length(2);
                    ...
                    it("works", _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
                        return regeneratorRuntime.wrap(function(_context3) {
                            for (;;) switch (_context3.prev = _context3.next) {
                              case 0:
                                return _context3.next = 2, test.setAsync(_cite["default"].ids, noGraph);

                              case 2:
                                (0, _expect["default"])(test.data).to.have.length(2), (0, _expect["default"])(test.data).to.eql(_cite["default"].ids), 
                                (0, _expect["default"])(test.log).to.have.length(1);
                        ...
                        return regeneratorRuntime.wrap(function(_context4) {
                            for (;;) switch (_context4.prev = _context4.next) {
                              case 0:
                                return _context4.next = 2, test.setAsync(_cite["default"].empty, !0);

                              case 2:
                                (0, _expect["default"])(test.data).to.have.length(1), (0, _expect["default"])(test.log).to.have.length(2);
                    ...
                    it("works", function() {
                        test.reset(), (0, _expect["default"])(test.data).to.have.length(0), (0, _expect["default"])(test.log).to.have.length(1);
                    }), it("saves", function() {
                        test.add(_cite["default"].empty), test.reset(!0), (0, _expect["default"])(test.data).to.have.length(0), 
                        (0, _expect["default"])(test.log).to.have.length(2);
                    });
                    ...
                    it("works", function() {
                        test.options({
                            format: "1"
                        }), (0, _expect["default"])(test._options.format).to.be("1"), (0, _expect["default"])(test.log).to.have.length(1);
                    }), it("saves", function() {
                        test.options({
                            format: "2"
                        }, !0), (0, _expect["default"])(test._options.format).to.be("2"), (0, _expect["default"])(test.log).to.have.length(2);
                    });
                }), describe("currentVersion()", function() {
                    it("works", function() {
                        (0, _expect["default"])(test.currentVersion()).to.be(1), test.add(_cite["default"].empty, !0), 
                        (0, _expect["default"])(test.currentVersion()).to.be(2);
                    });
                }), describe("retrieveVersion()", function() {
                    it("works", function() {
                        (0, _expect["default"])(test.log).to.have.length(1), test.add(_cite["default"].empty, !0), 
                        (0, _expect["default"])(test.log).to.have.length(2);
                        var test2 = test.retrieveVersion(1);
                        (0, _expect["default"])(test2.log).to.have.length(1), (0, _expect["default"])(test2.data).to.have.length(1);
                    }), it("doesn't change origin data", function() {
                        (0, _expect["default"])(test.log).to.have.length(1), test.add(_cite["default"].empty, !0), 
                        (0, _expect["default"])(test.log).to.have.length(2);
                        var test2 = test.retrieveVersion(1);
                        (0, _expect["default"])(test2.log).to.have.length(1), (0, _expect["default"])(test2.data).to.have.length(1), 
                        (0, _expect["default"])(test.log).to.have.length(2), (0, _expect["default"])(test.data).to.have.length(2);
                    }), it("handles empty input", function() {
                        test.add(_cite["default"].empty, !0);
                        var image = test.retrieveVersion();
                        (0, _expect["default"])(image.data).to.have.length(1), (0, _expect["default"])(image.log).to.have.length(1);
                    }), it("handles invalid input", function() {
                        (0, _expect["default"])(test.retrieveVersion(50)).to.be(null), (0, _expect["default"])(test.retrieveVersion(-1)).to.be(null);
                    });
                }), describe("undo()", function() {
                    it("works", function() {
                        (0, _expect["default"])(test.log).to.have.length(1), test.add(_cite["default"].empty, !0).save(), 
                        (0, _expect["default"])(test.log).to.have.length(3);
                        var test2 = test.undo();
                        (0, _expect["default"])(test2.log).to.have.length(2), (0, _expect["default"])(test2.data).to.have.length(1);
                    }), it("doesn't change origin data", function() {
                        (0, _expect["default"])(test.log).to.have.length(1), test.add(_cite["default"].empty, !0).save(), 
                        (0, _expect["default"])(test.log).to.have.length(3);
                        var test2 = test.undo();
                        (0, _expect["default"])(test.log).to.have.length(3), (0, _expect["default"])(test.data).to.have.length(2), 
                        (0, _expect["default"])(test2.log).to.have.length(2), (0, _expect["default"])(test2.data).to.have.length(1);
                    });
                    ...
                    it("works", function() {
                        (0, _expect["default"])(test.log).to.have.length(1), test.save().add(_cite["default"].empty).save(), 
                        (0, _expect["default"])(test.log).to.have.length(3);
                        var test2 = test.undo();
                        (0, _expect["default"])(test2.log).to.have.length(2), (0, _expect["default"])(test2.data).to.have.length(1);
                    }), it("doesn't change origin data", function() {
                    ...
                    it("works", function() {
                        test.set(_cite["default"].sort), (0, _expect["default"])(test.data[0].author[0].family).to.be("b"), 
                        (0, _expect["default"])(test.data[1].author[0].family).to.be("a"), test.sort(), 
                        (0, _expect["default"])(test.data[0].author[0].family).to.be("a"), (0, _expect["default"])(test.data[1].author[0].family).to.be("b"), 
                        (0, _expect["default"])(test.log).to.have.length(1);
                    }), it("saves", function() {
                        test.set(_cite["default"].sort), (0, _expect["default"])(test.data[0].author[0].family).to.be("b"), 
                        (0, _expect["default"])(test.data[1].author[0].family).to.be("a"), test.sort([], !0), 
                        (0, _expect["default"])(test.data[0].author[0].family).to.be("a"), (0, _expect["default"])(test.data[1].author[0].family).to.be("b"), 
                        (0, _expect["default"])(test.log).to.have.length(2);
                    });
                }), describe("getIds()", function() {
                    it("works", function() {
                        test.set(_cite["default"].ids), (0, _expect["default"])(test.data[0].id).to.be("b"), 
                        (0, _expect["default"])(test.data[1].id).to.be("a");
                        var out = test.getIds();
                        (0, _expect["default"])(out[0]).to.be("b"), (0, _expect["default"])(out[1]).to.be("a");
                    });
                });
            });
        });
    ...
    18: [ function(require, module, exports) {
        "use strict";
        var _syncRequest = _interopRequireDefault(require("sync-request")), _expect = _interopRequireDefault(require("expect.js")), _citation = _interopRequireDefault(require("./citation")), _parse = _interopRequireDefault(require("./input/parse")), _parse2 = _interopRequireDefault(require("./output/parse"));
        function _interopRequireDefault(obj) {
            return obj && obj.__esModule ? obj : {
                "default": obj
            };
        ...
        _parse["default"].wd.simple = require("./Q21972834.json"), _parse["default"].wd.author = require("./Q27795847.json");
        try {
            (0, _syncRequest["default"])();
        } catch (e) {}
        var wikidataTestCaseOptions = {
            callback: function(_ref) {
                return _slicedToArray(_ref, 1)[0].replace(/[&?]origin=\*/, "");
            },
            link: !0
        }, doiLinkTestCaseOptions = {
            link: !0
        }, configs = {
            ...
            "@doi/api": [ _parse["default"].doi.url, _parse2["default"].doi.simple.title, {
                link: !0,
        ...
        }, testCaseGenerator = function(type, input, output) {
            var opts = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
            return function() {
                var _opts$requirements = opts.requirements, requirements = void 0 === _opts$requirements ? {} : _opts$requirements, callback = opts.callback, _opts$link = opts.link, link = void 0 !== _opts$link && _opts$link, methods = _citation["default"].parse.input, method = link ? methods.chainLink : methods.chain;
                it("handles input type", function() {
                    ...
                    "function" == typeof callback && (data = callback(data)), (0, _expect["default"])(data).to.eql(output);
                });
                var _loop = function(requirement) {
                    var predicate = requirements[requirement];
                    it(requirement, function() {
                        return predicate(input, output, opts);
                    });
                };
                for (var requirement in requirements) _loop(requirement);
            };
        };
        describe("input", function() {
            this.timeout(4e3);
            var _loop2 = function(spec) {
                var specConfig = configs[spec], callback = void 0;
                callback = Array.isArray(specConfig) ? testCaseGenerator.apply(void 0, [ spec ].concat(_toConsumableArray(specConfig))) : function() {
                    for (var specContext in specConfig) context(specContext, testCaseGenerator.apply(void 0, [ spec ].concat(_toConsumableArray(specConfig[specContext]))));
                }, describe(spec, callback);
            };
            for (var spec in configs) _loop2(spec);
        });
    }, {
        "./Q21972834.json": 12,
        "./Q27795847.json": 13,
        ...
        module.exports = {
            ...
            bibjson: {
                simple: {
                    ...
                    journal: {
                        value: [ "Journal of Ethnobiology and Ethnomedicine" ]
                    },
                    title: {
                        value: [ "Gitksan medicinal plants-cultural choice and efficacy" ]
                    },
                    authors: {
                        value: [ "Leslie Main Johnson" ]
                    },
                    date: {
                        value: [ "2006-06-21" ]
                    },
                    doi: {
                        value: [ "10.1186/1746-4269-2-29" ]
                    },
                    volume: {
                        value: [ "2" ]
                    },
                    ...
                    fulltext_html: {
                        value: [ "http://ethnobiomed.biomedcentral.com/articles/10.1186/1746-4269-2-29" ]
                    },
                    fulltext_pdf: {
                        value: [ "http://ethnobiomed.biomedcentral.com/track/pdf/10.1186/1746-4269-2-29?site=http://ethnobiomed.biomedcentral.com" ]
                    },
                    license: {
                        value: [ "This article is published under license to BioMed Central Ltd. This is an Open Access article distributed under the terms of the Creative Commons Attribution License (http://creativecommons.org/licenses/by/2.0), which permits unrestricted use, distribution, and reproduction in any medium, provided the original work is properly cited." ]
                    },
                    copyright: {
                        value: [ "2006 Johnson; licensee BioMed Central Ltd." ]
                    }
                }
            },
            csl: {
    ...
    22: [ function(require, module, exports) {
        "use strict";
        var _expect = _interopRequireDefault(require("expect.js")), _citation = _interopRequireDefault(require("./citation")), _get = _interopRequireDefault(require("./input/get")), _get2 = _interopRequireDefault(require("./output/get"));
        function _interopRequireDefault(obj) {
            return obj && obj.__esModule ? obj : {
                "default": obj
            };
        ...
        var customTemplate = '<?xml version="1.0" encoding="utf-8"?>\n<style xmlns="http://purl.org/net/xbiblio/csl" class="in-text" version="1.0" demote-non-dropping-particle="sort-only" page-range-format="minimal">\n  <bibliography>\n    <layout>\n      <text variable="title"/>\n    </layout>\n  </bibliography>\n</style>', customLocale = '<?xml version="1.0" encoding="utf-8"?>\n<locale xmlns="http://purl.org/net/xbiblio/csl" version="1.0" xml:lang="custom">\n  <style-options punctuation-in-quote="true"/>\n  <date form="text">\n    <date-part name="month" suffix=" "/>\n    <date-part name="day" suffix=", "/>\n    <date-part name="year"/>\n  </date>\n  <date form="numeric">\n    <date-part name="month" form="numeric-leading-zeros" suffix="/"/>\n    <date-part name="day" form="numeric-leading-zeros" suffix="/"/>\n    <date-part name="year"/>\n  </date>\n  <terms>\n    <term name="no date" form="short">custom</term>\n  </terms>\n</locale>', testCaseGenerator = function(data, options, output) {
            var _ref = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {}, _ref$callback = _ref.callback, callback = void 0 === _ref$callback ? function(v) {
                return v;
            } : _ref$callback, _ref$msg = _ref.msg, msg = void 0 === _ref$msg ? "outputs correctly" : _ref$msg;
            return function() {
                var out = callback(data.get(options));
                out = "string" == typeof out ? out.trim() : out, it(msg, function() {
                    return (0, _expect["default"])(out).to["object" === _typeof(out) ? "eql" : "be"](output);
                });
            };
        }, defaultOpts = _citation["default"].prototype.defaultOptions, opts = function(format, type, style) {
            return {
                format: format,
                type: type,
                style: style,
                lang: arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : defaultOpts.lang
            };
        };
            ...
            describe("formatted CSL", function() {
                describe("html", function() {
                    ...
                    describe("custom template", function() {
                        _citation["default"].CSL.register.addTemplate("custom", customTemplate), it("registers the template", function() {
                            (0, _expect["default"])(_citation["default"].CSL.register.hasTemplate("custom")).to.be(!0), 
                        ...
                        _citation["default"].CSL.register.addLocale("custom", customLocale), it("registers the locale", function() {
                            (0, _expect["default"])(_citation["default"].CSL.register.hasLocale("custom")).to.be(!0), 
                        ...
                        context("static", testCaseGenerator(data, {
                            ...
                            append: "b",
                            prepend: "a"
                        }, _get2["default"].csl.html.wrappedStatic)), context("dynamic", testCaseGenerator(data, {
                            format: "string",
                            type: "html",
                            style: "citation-apa",
                ...
                describe("plain text", testCaseGenerator(data, opts("string", "string", "bibtex"), _get2["default"].bibtex.plain, {
                    ...
                    style: "bibtex"
                }, _get2["default"].bibtex.json)), describe("Bib.TXT", testCaseGenerator(data, opts("string", "string", "bibtxt"), _get2["default"].bibtex.bibtxt));
    ...
    24: [ function(require, module, exports) {
        module.exports = {
            wd: {
                ...
                api: [ "https://www.wikidata.org/w/api.php?action=wbgetentities&ids=Q21972834&format=json&languages=en", "https://www.wikidata.org/w/api.php?action=wbgetentities&ids=Q21972834%7CQ27795847&format=json&languages=en" ]
            },
            doi: {
                simple: [ {
                    indexed: {
                ...
                api: [ [ "https://doi.org/10.1021/ja01577a030" ], [ "https://doi.org/10.1021/ja01577a030", "https://doi.org/10.1021/ci025584y" ] ]
            },
            bibtex: {
                simple: [ {
    ...
    25: [ function(require, module, exports) {
        require("./async.spec"), require("./cite.spec"), require("./input.spec"), require("./output.spec");
    }, {
        "./async.spec": 15,
        "./cite.spec": 17,
        "./input.spec": 18,
